...
extern "C"
{
	 ...
	 */
	typedef void(*opensl_process_t)(void *context, int sample_rate, int buffer_frames, int input_channels, const short *input_buffer, int output_channels, short *output_buffer);
	 ...
	 */
	OPENSL_STREAM *opensl_open(int sample_rate, int input_channels, int output_channels,int callback_buffer_size, opensl_process_t proc, void *context);

...
// This is an simple digital clock. The background is what Shadertoy gives us as the default "New Shader". Despite of the simpleness of the display, it does too much calculation: it works in about 4.2 fps in my computer(Google Chrome 30, Core2Duo 2.10GHz)
/**

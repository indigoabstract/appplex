...
// S: toggles sky SPACE: decompos In Siggraph'85, Gardner proposed a smart way to fake hypertextures with simple ellipsoids. The secret is to have transparency (or the density noise) vanishing at silhouettes, i.e., view-dep (e.g. based on dot(N,Eye) ).

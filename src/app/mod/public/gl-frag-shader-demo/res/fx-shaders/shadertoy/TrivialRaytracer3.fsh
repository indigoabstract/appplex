...
// Tried out some raytracing to see how it works. Three spheres, two point lights, diffuse and specular lighting. There's probably something wrong with the horizon.
struct traceResult {
	float d;
	vec3 intersection;
	vec3 normal;

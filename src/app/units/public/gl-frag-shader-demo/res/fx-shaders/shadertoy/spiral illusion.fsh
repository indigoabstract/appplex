...
// Only big circles of small squares here ! mouse.x tunes rotation. mouse.y tunes squares size. 2: toggles 1 every 2 circles. C: toggles alternate B/W. E: toggles empty square. I: toggles inverse rotation at every circle.

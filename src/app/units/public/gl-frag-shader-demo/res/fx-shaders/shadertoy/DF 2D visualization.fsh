// https://www.shadertoy.com/view/4sXGDr
// Illustration of distance fields raymarching/spheretracing principle in 2D. Use mouse to shoot the ray. //little edit - isolated CSG funtions to make code more verbose and fixed sign of the field - now red is [+] and blue [-].
// ----- SHAPES
...
void main(void)
{
	vec2 uv = (gl_FragCoord.xy - iResolution.xy * 0.5) / 50.0;
	...
	gl_FragColor = vec4(dist_col /*+ region_col*/ + raymarch_vis_col, 1.0);
}

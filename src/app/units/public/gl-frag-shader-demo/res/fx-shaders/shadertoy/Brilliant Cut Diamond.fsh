...
// Brilliant cut diamond. Click to rotate view.
...
void main(void){
	...
	vec2 screen_point=vec2((gl_FragCoord.x-iResolution.x/2.0)/iResolution.x*ratio,(gl_FragCoord.y-iResolution.y/2.0)/iResolution.y);

// https://www.shadertoy.com/view/XdXXWn
// mouse.x: zoom mouse.y: grey level of dots
float t = iGlobalTime;
...
void main(void)
{
	vec2 uv = (gl_FragCoord.xy -.5*iResolution.xy)/ ( floor(iResolution.y/64.)*64.);

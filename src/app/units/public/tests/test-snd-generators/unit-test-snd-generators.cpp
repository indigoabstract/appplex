...
namespace unit_test_snd_generators_ns
{
	...
	public:
		...
		static gfx_color get_note_color(musical_note::note_ids inote)
		{
			...
			throw ia_exception("illegal value for note");
		}
	...
	public:
		...
		virtual void update_view(shared_ptr<mws_camera> g)
		{
			...
			g->setColor(0x808080);
			g->drawLine(60, 0, 60, get_unit()->get_height());
			g->drawLine(780, 0, 780, get_unit()->get_height());

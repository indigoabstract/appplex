...
#include "unit-test-gl-uniform-blocks.hxx"
#include "pfm-gl.h"
#include "gfx.hxx"
...
using namespace unit_test_gl_uniform_blocks_ns;

void unit_test_gl_uniform_blocks::load()
{
}

void unit_test_gl_uniform_blocks::update_view(int update_count)
{

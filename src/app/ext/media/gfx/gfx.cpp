...
shared_ptr<gfx_tex> gfx::tex::new_tex_2d(std::string iuni_tex_name)
{
	check_init();
	...
	tex = shared_ptr<gfx_tex>(new gfx_tex(iuni_tex_name));
	tex_list.push_back(tex);

	return tex;
}

shared_ptr<gfx_tex> gfx::tex::new_tex_2d(std::string iuni_tex_name, int iwith, int iheight)
{
	check_init();
	shared_ptr<gfx_tex> tex = get_texture_by_name(iuni_tex_name);
	...
	tex = shared_ptr<gfx_tex>(new gfx_tex(iuni_tex_name, iwith, iheight, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, gfx_tex::TEX_2D));
	tex_list.push_back(tex);

	return tex;
}

shared_ptr<gfx_tex> gfx::tex::new_tex_2d(std::string iuni_tex_name, int iwith, int iheight, std::string iformat)
{
	check_init();
	shared_ptr<gfx_tex> tex = get_texture_by_name(iuni_tex_name);
	...
	tex = shared_ptr<gfx_tex>(new gfx_tex(iuni_tex_name, iwith, iheight, ti->internal_format, ti->format, ti->type, gfx_tex::TEX_2D));
	tex_list.push_back(tex);

	return tex;
}

shared_ptr<gfx_tex> gfx::tex::new_tex_2d(std::string iuni_tex_name, int iwith, int iheight, int iinternal_format, int iformat, int itype)
{
	check_init();
	shared_ptr<gfx_tex> tex = get_texture_by_name(iuni_tex_name);
	...
	tex = shared_ptr<gfx_tex>(new gfx_tex(iuni_tex_name, iwith, iheight, iinternal_format, iformat, itype, gfx_tex::TEX_2D));
	tex_list.push_back(tex);

	return tex;
}

shared_ptr<gfx_tex> gfx::tex::new_external_tex_2d(std::string iuni_tex_name, int itexture_id, int iwith, int iheight, int iinternal_format, int iformat, int itype)
{
	check_init();
	shared_ptr<gfx_tex> tex = get_texture_by_name(iuni_tex_name);
	...
	tex = shared_ptr<gfx_tex>(new gfx_tex(iuni_tex_name, itexture_id, iwith, iheight, iinternal_format, iformat, itype, gfx_tex::TEX_2D));
	tex_list.push_back(tex);
...
void gfx::get_render_target_pixels_impl(shared_ptr<gfx_rt> irt, void* ivect)
{
	...
	if (rt::get_current_render_target())
	{
		...
		glReadPixels(0, 0, rt::get_render_target_width(), rt::get_render_target_height(), att->format, att->type, ivect);
	}
	else
	{

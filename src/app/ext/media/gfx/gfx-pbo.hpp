...
public:
   ...
   std::function<void(gfx_ubyte* i_data, int i_size)> on_data_recv_handler;
...
public:
   ...
   void set_on_data_recv_handler(std::function<void(gfx_ubyte* i_data, int i_size)> i_handler);

...
// I cannot describe my shader. UPD: actually, I can: it's a physics-based atmospheric scattering with some fractal-value-noise-based clouds thrown into the mix. It is also very slow (well, 99% physics, 1% hacks!) and glitchy. Use mouse to move sun around.

...
// Drag mouse horizontally to increase frequency, Drag mouse vertically to change the minkowski order. Using glsl derivatives for lighting, faster but somewhat pixelated.

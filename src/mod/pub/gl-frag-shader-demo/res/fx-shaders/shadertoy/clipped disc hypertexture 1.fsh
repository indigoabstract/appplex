...
// hypertexture (here, sphere clipped by plane) with well controlled thickness, i.e., noise saturating the "skin" range. mouse.x tune noise layer thickness mouse.y tune noise bluriness See #define for more tunings

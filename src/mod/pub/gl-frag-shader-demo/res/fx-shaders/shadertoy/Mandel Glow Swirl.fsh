// https://www.shadertoy.com/view/4slXD7
...
{
	// anti-aliasing
	gl_FragColor.rgb  = fractal( gl_FragCoord.xy + vec2(5,1)/8.0 );
	gl_FragColor.rgb += fractal( gl_FragCoord.xy + vec2(1,3)/8.0 );
	gl_FragColor.rgb += fractal( gl_FragCoord.xy + vec2(7,5)/8.0 );
	gl_FragColor.rgb += fractal( gl_FragCoord.xy + vec2(3,7)/8.0 );

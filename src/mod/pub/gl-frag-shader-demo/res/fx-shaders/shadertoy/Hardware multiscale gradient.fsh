// https://www.shadertoy.com/view/ldsSzN

// iChannel0: t4
// iChannel1: t1
// iChannel2: kb

// cheap texture gradiant using hardware derivative at each MIPmap level. mouse = parameter tuning. No mouse -> auto-demo. C: add the ultra-lowres image M: uses module(grad) instead SPACE: show base texture G: shows grad at MIPmap level = mouse.x

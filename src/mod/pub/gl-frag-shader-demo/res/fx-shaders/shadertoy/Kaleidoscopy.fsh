// https://www.shadertoy.com/view/lssSWM

// iChannel0: t14
// iChannel1: t9

// Trying to make a 3D fractal with what I've learnt from messing with mandelbrots. I can't work out how to centre the camera on it! N.B. uses cheap ambient occlusion and specular occlusion (see Shade() function).
// Ben Quantock 2014

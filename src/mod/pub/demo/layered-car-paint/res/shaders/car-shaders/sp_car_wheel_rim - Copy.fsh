...
void main()
{
	...
	vec3 v3_normal_ws = normalize(m3_ns_to_ws * v3_flake_nrm_ns);
	//v3_normal_ws = normalize(v3_normal_ws + m3_ws_tf * v_v3_normal);
	...
	vec3 v3_frag_color = v4_reflected_color.rgb * v1_reflected_color_weight + v4_paint_layer_color.rgb*0.5;

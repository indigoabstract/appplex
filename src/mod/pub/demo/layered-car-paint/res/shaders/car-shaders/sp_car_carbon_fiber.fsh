...
void main()
{
	...
	float v1_cm_bias = 4.0;//u_v1_gloss_level;
	...
	v4_reflected_color.rgb *= v4_reflected_color.a * 1.25;// * u_v1_brightness_factor;
	...
	float v1_sf = pow(max(0.0, dot(-v3_cam_dir, v3_normal_ws)), 5.0)*0.250;
	vec3 v3_frag_color = v4_diffuse_color.rgb*v3_dot_view_normal*1.5 + vec3(1.0) * v1_sf + v4_reflected_color.rgb * v1_reflected_color_weight;// + v4_paint_layer_color.rgb;

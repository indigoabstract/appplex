...
#include "mod-layered-car-paint.hxx"
...
namespace
{
   ...
   public:
      ...
      mws_sp<mod_layered_car_paint> get_mod()
      {
         return unit.lock();
      }
   ...
   public:
      enum e_material_types
      {
         ...
         e_car_glass,
         e_car_headlights,
         e_car_headlights_glass,
         e_car_chassis,
         e_car_interior,
      };

      mod_layered_car_paint_impl(mws_sp<mod_layered_car_paint> iunit)
      {
         unit = iunit;
         t = 0;
      ...
      void init(mws_sp<gfx_scene> gfx_scene_inst)
      {
         ...
         // cubemap
         {
            ...
            r_cube_mesh["u_scm_skybox"] = cubemap_name;
         ...
         // mustang
         {
            ...
            const mws_sp<gfx_material> mesh_materials[DIM] =
            {
               mat_car_body, /*mat_car_body_3,*/ mat_car_chassis, mat_car_headlights_glass,
      ...
      std::string cubemap_name = "showroom";
...
mod_layered_car_paint::mod_layered_car_paint() : mws_mod(mws_stringify(MOD_LAYERED_CAR_PAINT)) {}

mws_sp<mod_layered_car_paint> mod_layered_car_paint::nwi()
{
   return mws_sp<mod_layered_car_paint>(new mod_layered_car_paint());
}

void mod_layered_car_paint::init()
{
}
      ...
      for (; its != spec_file_list.end(); its++)
      {
         ...
         for (; it2 != file_list->end(); it2++)
         {
            ...
            if (mws_str::starts_with(diff_fname, root) && !ends_with(diff_fname, "_S.png") && (std::find(diff_file_list.begin(), diff_file_list.end(), diff_fname) == diff_file_list.end()))
            {
               ...
               mws_println("\t%s", diff_fname.c_str());
            }
         }
      }
   }
...
bool mod_layered_car_paint::update()
{
   float& t = p->t;

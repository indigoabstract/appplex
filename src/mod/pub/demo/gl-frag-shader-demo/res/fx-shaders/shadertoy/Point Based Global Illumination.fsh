// https://www.shadertoy.com/view/MsXSzn
// An approximation of global illumination (noise free) by a disk to disk approach. Distance field is only use to show the cornell box, not for computing GI.

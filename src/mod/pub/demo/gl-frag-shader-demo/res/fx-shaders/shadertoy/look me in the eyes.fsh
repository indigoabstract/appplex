...
// look at the center for 1 minute, then press SPACE T: toggles rotation direction S: stop/go 2: 2 spirals (mouse location) R: reverse orientation T : opposite rotation
float t = iGlobalTime;

...
// Playing with different ways of animating noise. In this version, the noise is made using a technique similar to "flow noise" (maybe it even qualifies as flow noise)

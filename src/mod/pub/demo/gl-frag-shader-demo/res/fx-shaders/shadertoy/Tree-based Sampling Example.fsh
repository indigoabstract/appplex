...
// An extension to iq's https://www.shadertoy.com/view/XslGRr. By LODing the samples and keeping them close to stationary in the world, we can visualise an expansive volume with a fast moving camera with just 32 ray steps. Click to turn new approach off.

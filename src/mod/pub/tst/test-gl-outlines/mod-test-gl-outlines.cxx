...
mod_test_gl_outlines::mod_test_gl_outlines() : mws_mod(mws_stringify(MOD_TEST_GL_OUTLINES)) {}

mws_sp<mod_test_gl_outlines> mod_test_gl_outlines::nwi()
{
   return mws_sp<mod_test_gl_outlines>(new mod_test_gl_outlines());
}


namespace mod_test_gl_outlines_ns
{
...
using namespace mod_test_gl_outlines_ns;

void mod_test_gl_outlines::load()
{
}

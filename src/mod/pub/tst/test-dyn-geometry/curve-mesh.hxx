...
public:
	...
	void calc_points(std::vector<mws_ptr_evt::touch_point>& ipoint_list);
	void calc_geometry();

	void sample_touch_points(int istart_idx, int iend_idx, std::vector<mws_ptr_evt::touch_point>& ipoint_list);
	void sample_ncs_points(int istart_idx, int iend_idx, std::vector<mws_ptr_evt::touch_point>& ipoint_list);

...
#ifdef V2
	ans += texture2D(iChannel0, vec2(ans2/len*.008+.74, th+.3)).r * 0.13;
	ans += texture2D(iChannel0, vec2(ans2/len*.01+.91, th+.3)).r * 0.06;
	ans += texture2D(iChannel0, vec2(ans2/len*.03+.5 , th+.4)).g * 0.06;
	ans += texture2D(iChannel0, vec2(ans2/len*.03+.51, th+.4)).g * 0.03;
#else
	ans += texture2D(iChannel0, vec2(ans2/len*.02+.74, th+.3)).r * 0.17;
	ans += texture2D(iChannel0, vec2(ans2/len*.02+.91, th+.3)).r * 0.09;
	ans += texture2D(iChannel0, vec2(ans2/len*.07+.5 , th+.4)).g * 0.09;
	ans += texture2D(iChannel0, vec2(ans2/len*.07+.51, th+.4)).g * 0.05;
#endif
...
float trunk(in float ang, in vec2 uv, in float len, in float strength, in float sharpness )
{
	...
	float t = pow(1.-ans2/len, .25)*strength + (1.0-ans2/len)*texture2D(iChannel0, vec2(ans2/len*.3, len*.8)).r*.025;
#ifdef V2
	ans += texture2D(iChannel0, vec2(ans2/len*.1, strength)).r * 0.04;
#else
	ans += texture2D(iChannel0, vec2(ans2/len*.2, strength)).r * 0.08;
#endif
...
float fir(in float ang, in vec2 uv, in float len, in float strength, in float sharpness )
{
	...
	float t = pow(1.-ans2/len, .25)*strength + (1.0-ans2/len)*texture2D(iChannel0, vec2(ans2/len*.3, len*.8)).r*.15;
	ans += texture2D(iChannel0, vec2(ans2/len*.2, strength)).r * 0.04;

...
// First tweaks with raymarching distance fields, based on "Raymarch Tut Thingy" by squeakyneb (https://www.shadertoy.com/view/MssXWM). Had fun with operation, repetition, (approximative) lighting, (very) simple volumetric texturing... Quick and dirty...
...
void main(void)
{
	vec2 uv = (gl_FragCoord.xy / iResolution.xy - 0.5) * vec2(2.0,2.0/(iResolution.x/iResolution.y)); 

// https://www.shadertoy.com/view/XslSW7
// Conversion of an old generative art program to GLSL. Could probably do more with this method, might go for a #2 too. Run in fullscreen!
#define SUPERSAMPLE

...
// Insipred by iq's "Hexagons - distance" (https://www.shadertoy.com/view/Xd2GR3). Any SDF can be used with the voxelize function, it also performs rather well with degenerate SDFs. Feel free to reuse for your shadertoys.
...
vec3 lgt = vec3(4.+sin(time*0.4)*20.,4.+sin(time*.1)*10.,5.);

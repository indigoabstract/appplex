...
// Some code-duplication for the sake of self-reflections, no regrets.
// The background was the first part I did for this shader. I then felt it needed some flat, reflective geometry to reflect the background at specific angles (looking back or at 90 degrees off to the side etc). This was the result.

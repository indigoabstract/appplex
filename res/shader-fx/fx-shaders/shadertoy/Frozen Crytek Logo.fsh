...
// The Crytek logo inside a melting block of Ice. A quick refraction and blending shapes experiment. Use the mouse to look around.
...
void main(void)
{
    ...
    vec2 puv = -1.0 + 2.0 * gl_FragCoord.xy / iResolution.xy;

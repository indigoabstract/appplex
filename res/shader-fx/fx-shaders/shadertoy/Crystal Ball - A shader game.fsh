...
// A fist attempt on creating a shader game. - Track the ball by dragging the mouse cursor (yellow dot) over the ball. - Both reflections of the ball in the walls show the future state of the ball, to help tracking it
//aaecheve 2013
...
void main()
{
  vec3 normalizedPosition = vec3(gl_FragCoord.xy / iResolution.x, 0);

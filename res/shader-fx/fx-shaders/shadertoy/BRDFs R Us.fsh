...
// all ur BRDFs are belong to ... 100 from MERL database, fit by this paper: http://hal.inria.fr/docs/00/70/23/04/PDF/paper.pdf time in seconds = material index in SetMat for shape in middle of screen If you have a good system, increase AWESOMENESS to 100

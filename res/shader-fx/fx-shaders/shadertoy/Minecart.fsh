...
// My entry to the inofficial, nonexistent st mine compo :) Click and hold to sit in cart. Performancewise ... I think it was a big mistake to lookup textures inside the scene function. Will avoid that in future.
// mine + cart, fragment shader by movAX13h (filip.sound@gmail.com), June 2014
// sound by srtuss
// Damn, now i want a roller coaster.

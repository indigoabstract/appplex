...
// Based on (www.shadertoy.com/view/XsfGWN), I wanted to implement fur on a more generic distance field, The idea is to apply the deformations from the distance field to the fur density in the radial direction, and the shading from the original field.

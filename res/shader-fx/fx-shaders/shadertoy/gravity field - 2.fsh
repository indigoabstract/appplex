...
// inside an homogeneous sphere, only the mass closer to center than you contributes to your gravity. What about an heterogeneous bag of stars ? (illustrated with 2D gravity in 1/r). Mouse.x to force colormap. Clamps stars out of mouse.y radius.

...
// Some waterfalls and a rainbow. Made with so many hacks I don't know what is real any more. ...I still need to work on the camera
// Waterfalls - @P_Malin
...
void main(void)
{
	gPixelRand = hash(fract(iGlobalTime) + gl_FragCoord.x + gl_FragCoord.y * 1009.0);

// https://www.shadertoy.com/view/MslXD8
// Snapping points on a grid to the surface of a distance field, then applying binary marching cube to the resulting dual grid

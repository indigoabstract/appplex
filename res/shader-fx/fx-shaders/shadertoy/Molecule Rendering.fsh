...
// I wrote a simple script to parse a molfile and print the corresponding shader. Click and drag the mouse to rotate the molecule. Figuring out the molecule name is left as an exercice to the reader ;)
// #define BLUE
// #define RED

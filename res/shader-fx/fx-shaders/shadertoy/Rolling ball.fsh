...
// I wanted to see if I could trace the grass back from a ball in my 'Rolling Hills' grass shader. Mouse to move through time.
...
void main(void)
{
	...
	float gTime = (iGlobalTime*5.0+m+462.0)*.006;

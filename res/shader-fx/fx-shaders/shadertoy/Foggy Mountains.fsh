// https://www.shadertoy.com/view/MdX3zX
...
float noise( in vec3 x )
{
	...
	vec2 uv2 = uv1  + offz;
	return mix(texture2D( iChannel0, uv1 ,-1000.0).x,texture2D( iChannel0, uv2 ,-1000.0).x,fract(z))-0.5;
}
...
void main(void)
{	
    time        = iGlobalTime*4.8+floor(iGlobalTime*0.1)*120.0+210.0;

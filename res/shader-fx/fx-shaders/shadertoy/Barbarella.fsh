...
// Based on Metatunnel by FRequency, really old, might not work on your card yet
...
void main(void)
{
    vec2 p=-1.+2.*gl_FragCoord.xy / iResolution.xy;
    ...
    gl_FragColor=c+vec4(.3,.15,.15,1.)*(t*.03); // fleshtones
}

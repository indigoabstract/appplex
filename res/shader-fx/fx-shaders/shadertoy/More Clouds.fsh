// https://www.shadertoy.com/view/XdX3W4
...
{	
	...
	time = iGlobalTime+385.0; //i want the sun visible in the screenshot
	...
	float density_coef =0.13+float(density_modifier)
		+sin(iGlobalTime*float(density_osc_freq))*float(density_osc_amp);

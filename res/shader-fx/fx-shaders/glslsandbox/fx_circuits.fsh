// http://glsl.heroku.com/e#13101.0
#ifdef GL_ES
...
float flicker = noise1(u_v1_time * 2.0) * 0.8 + 0.4;
...
void main(void)
{
	...
	uv *= 0.6 + sin(u_v1_time * 0.1) * 0.4;
	uv = rotate(uv, sin(u_v1_time * 0.3) * 1.0);
	uv += u_v1_time * 0.4;
	...
	{	
		...
		if(i > 0)
		{
			...
			v2 = voronoi(uv * f * 0.5 + 50.0 + u_v1_time);

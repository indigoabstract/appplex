...
public: 
     ...
     * child. 
     */ 
    std::shared_ptr<postream> get_input(int desc) const
    { 
     ...
     */ 
    std::shared_ptr<pistream> get_output(int desc) const
    { 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                std::shared_ptr<postream> st(new postream(si.pipe_->wend())); 
        ...
        { 
            ...
            { 
                ...
                std::shared_ptr<pistream> st(new pistream(si.pipe_->rend())); 
...
private: 
     ...
     */ 
    typedef std::map<int, std::shared_ptr<postream> > input_map_t; 
     ...
     */ 
    typedef std::map<int, std::shared_ptr<pistream> > output_map_t; 

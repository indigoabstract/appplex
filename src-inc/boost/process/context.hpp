...
template <class Path>
class basic_work_directory_contextw
{ 
public: 
    basic_work_directory_contextw() 
    {
...
template <class Path> 
class basic_contextw : public basic_work_directory_contextw<Path>, public environment_context 
{ 
public: 
    stream_behavior stdin_behavior; 
    stream_behavior stdout_behavior; 
...
typedef basic_contextw<std::wstring> contextw; 
